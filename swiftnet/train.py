...
def run():
    with tf.Graph().as_default() as graph:
        ...
        _, probabilities= swiftnet.swiftnet(images, numclass=num_classes,is_training=True,shape=[image_height,image_width],l2=weight_decay,dropout=0.05,reuse=None)
        ...
        _, probabilities_val= swiftnet.swiftnet(images_val, numclass=num_classes,is_training=None,shape=[1024,2048],l2=None,dropout=0,reuse=True)
        ...
        with tf.Session(config=config) as sess:
            ...
            swiftnet.load_weight(sess,'imgnet_resnet18.npz',var1)#load base_net's parameter.
            step = 0;
